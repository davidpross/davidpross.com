...
Pursuing a master’s degree in bioinformatics and computational biomedicine with **anticipated graduation in June 2021**. I have a strong background in programming and user interface design. I am concluding a focused multi-year educational journey to apply these skills in the biological domain. I am ready to contribute on a technical team partnering with biologists to leverage computational tools to advance biology and biomedical research.
...
- Have given multiple internal presentations of the tool I developed—to senior level leadership as well as current customers—as the viewer will be an integral component of data analysis toolkit for early access collaborators using company’s forthcoming spatial molecular imager. Viewer is also being prepared for public access to showcase the data being generated with the new assay.
- Attended industry conference announcing new spatial biology technologies.
...
- Created two interactive apps for data visualization and analysis of multiplex immunohistochemistry and TCR-seq data using shiny R package.
...
- Proficient in bash, Python, VIM, git, and SQL, as well as other common programming tools.

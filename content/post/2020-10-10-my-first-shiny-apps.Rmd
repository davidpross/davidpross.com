...
This summer I worked at the [Earle A. Chiles Research Institute](https://oregon.providence.org/our-services/e/earle-a-chiles-research-institute/) doing bioinformatics analyses for a cancer immunology researcher. To allow the researcher to perform similar analyses in the future, without me present or knowing [R](https://www.r-project.org/about.html), I created a couple [Shiny](https://shiny.rstudio.com/) apps. These apps are a web interface to interactively explore data of different types. I have demos [here](https://daveross.shinyapps.io/ihc-viewer/) and [here](https://daveross.shinyapps.io/tcrr/), and more background information below.
...
![](/post/2020-10-10-my-first-shiny-apps_files/ihc.png){width=600px}
...
![](/post/2020-10-10-my-first-shiny-apps_files/circos.png){width=600px}
